  ...
  function Xa(Ya) {
    ...
    function Oa(a, b) {
      ...
      if ('object' === typeof a) {
        ...
        !b &&
          a &&
          c(I, ['bar'], ['left', 'right'], ['zoom', 'slide'], a.layout, a.position, a.transition);
      }
    }
    function Za() {
      var a = !1,
      ...
      G(document, 'keydown', function (c) {
        ...
        'Tab' === c.key &&
          (u &&
            (c.shiftKey
              ? document.activeElement === u[0] && (u[1].focus(), c.preventDefault())
              : document.activeElement === u[1] && (u[0].focus(), c.preventDefault()),
            b ||
              ka ||
              ((b = !0),
              !a && c.preventDefault(),
    ...
    function ab(a) {
      ...
      if (0 < b.length) {
        for (var e = 0; e < b.length; e++)
          -1 !== H(a, N[e])
            ? ((b[e].checked = !0), P[e] || (c.push(N[e]), (P[e] = !0)))
            : ((b[e].checked = !1), P[e] && (c.push(N[e]), (P[e] = !1)));
        if (Pa && V && 0 < c.length) {
          b = x.length;
          e = -1;
          var g = ia('', 'all'),
          ...
          for (k = 0; k < b; k++) {
            ...
            if (
              ...
              for (var J = 0; J < W; J++) {
                ...
                K = K.path || !1;
                q && (l = [q, '.' + q]);
                if (y) for (y = 0; y < g.length; y++) g[y].match(v) && n.push(g[y]);
    ...
    function Ta() {
      function a(c, d) {
        ...
        try {
          for (
            var l = c.querySelectorAll(b.join(':not([tabindex="-1"]), ')), k, t = l.length, m = 0;
            m < t;
            ...
            (k = l[m].getAttribute('data-focus')),
              g || '1' !== k
                ? '0' === k &&
                  ((e = l[m]), g || '0' === l[m + 1].getAttribute('data-focus') || (g = l[m + 1]))
                : (g = l[m]),
              m++;
        } catch (p) {
    ...
    function cb() {
      for (
        var a = document.querySelectorAll('a[data-cc="c-settings"], button[data-cc="c-settings"]'),
          b = 0;
        b < a.length;
        b++
      )
      ...
      switch (a) {
        ...
        case 'revision':
          return (
            ...
            (a = b.prompt_consent),
            (b = b.message),
            M && 'number' === typeof d && r.revision !== d
              ? ((Ba = !0),
                (Qa = b),
                (Y = !1),
                (pa = d),
                !0 === a ? (Aa(za), Oa(za.gui_options, !0), Ta(), h.show()) : h.accept(),
                (b = !0))
              : (b = !1),
            b
          );
